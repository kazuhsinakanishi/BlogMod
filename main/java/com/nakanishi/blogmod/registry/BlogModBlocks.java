...
public class BlogModBlocks {
    ...
    public static class Mod_Blocks {
        ...
        public static final RegistryObject<Block> PARCHED_CARROTS = MOD_BLOCKS.register("parched_carrots", ()-> new ParchedCarrotsBlock(BlockBehaviour.Properties.copy(Blocks.CARROTS)));
