...
public class BlogModItems {
    ...
    public static final RegistryObject<Item> ENDER_CARROT = MOD_ITEMS.register("ender_carrot", ()-> new ItemNameBlockItem(BlogModBlocks.Mod_Blocks.ENDER_CARROTS.get(), new Item.Properties().food(Foods.CARROT)));
